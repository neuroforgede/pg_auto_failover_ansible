...
Ansible Playbook(s) to create a cluster of PostgreSQL nodes running in a Ubuntu 18.04 cluster with [pg_auto_failover](https://github.com/citusdata/pg_auto_failover) 1.2 and PostgreSQL 12.
...
- NO automatic configuration of backups - Replication does replace regular backups!
